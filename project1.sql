...
INSERT INTO songs(id,name,length,album_id) VALUES (182,'Frodos Dream',3+(06/60),18);

SELECT * FROM songs;
-- change name of the column the data returns to Band Name
...
-- get all bands that have no album
SELECT bands.name AS 'Band Name'
FROM bands
...
LIMIT 1;
-- update the release year of the album with no Release Year to 1986
UPDATE albums
SET release_year = 1986
WHERE id = 4;
-- insert a record of your favorite band and one of their albums
INSERT INTO bands(name) VALUES('BEYONCE');
INSERT INTO albums(name,release_year,band_id) VALUES ('SASHA FIERCE',2010,8);
-- get the average length for all songs
